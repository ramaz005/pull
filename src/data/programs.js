...
export const programs = [
  ...
  },
  {
    ...
    ageGroup: "Любой возраст",
    description:
      "Занятия в малых группах (до 6 пловцов), сочетающие структурированное обучение и удовольствие учиться вместе со сверстниками.",
    benefits: ["До 6 пловцов в группе", "Общение и мотивация", "Ниже стоимость занятия"],
